...
declare module "@getpaseo/plugin" {
  ...
  export type PluginWorkspacePanelContribution =
    | { id: string; title: string; icon: string; context: "workspace"; locations?: readonly ("workspace" | "explorer")[]; Component: ComponentType<PluginWorkspacePanelProps> }
    | { id: string; title: string; icon: string; context: "agent"; locations?: readonly ("workspace" | "explorer")[]; Component: ComponentType<PluginAgentPanelProps> };
