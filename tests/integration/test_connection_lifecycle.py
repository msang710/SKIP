...
class ConnectionTests(unittest.TestCase):
    ...
    def test_active_runtime_diagnostics_ignores_cwd_module_shadow(self):
        ...
        self.assertEqual(value['actual_schema_versions'],[v for v,_,_ in Database.migrations()])
...
class DatabaseErrors(unittest.TestCase):
    ...
    def test_corruption_and_actual_schema_mismatch_are_distinct(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(result.exception.details['actual_schema_versions'],[v for v,_,_ in Database.migrations()])
